...
private fun VisibilityCard(visibility: Float, isMetric: Boolean, modifier: Modifier) {
    ...
    val levelRes = remember(visibility, isMetric) {
        when {
            visibility >= clearAt -> R.string.visibility_level_clear
            visibility >= goodAt -> R.string.visibility_level_good
            visibility >= moderateAt -> R.string.visibility_level_moderate
